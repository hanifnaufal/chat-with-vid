...
## Tasks / Subtasks
- [ ] Task 1: Create Home Page UI with URL Input (AC: 1)
  - [ ] Subtask 1.1: Implement the main input page at `/` route
  - [ ] Subtask 1.2: Add a YouTube URL input field with proper validation
  - [ ] Subtask 1.3: Add a "Process" button that triggers the submission
  - [ ] Subtask 1.4: Implement form validation for YouTube URLs
  - [ ] Subtask 1.5: Add error display for invalid URLs
