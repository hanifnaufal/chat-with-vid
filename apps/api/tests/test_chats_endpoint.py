...
def test_create_chat_valid_url(mock_chat_service):
    ...
    response = client.post(
        "/api/chats", json={"source_url": "https://www.youtube.com/watch?v=dQw4w9WgXcQ"}
    )
...
def test_create_chat_invalid_url():
    ...
    response = client.post("/api/chats", json={"source_url": "https://www.google.com"})
...
def test_create_chat_invalid_payload():
    ...
    response = client.post("/api/chats", json={"source_url": "not-a-url"})
